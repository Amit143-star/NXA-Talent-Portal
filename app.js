    ...
    mountCore(state) {
        ...
        DOM.root.innerHTML = `
            ...
            <div class="bottom-nav">
                ...
                ` : `
                    <div class="bottom-nav-item ${state.view === 'student_mgmt' ? 'active' : ''}" data-view="student_mgmt">
                        <span style="font-size: 1.2rem;">📂</span>
                    </div>
                    <div class="bottom-nav-item ${state.view === 'live' ? 'active' : ''}" data-view="live">
                        <span style="font-size: 1.2rem;">📡</span>
                    </div>
                    <div class="bottom-nav-item ${state.view === 'notifications' ? 'active' : ''}" data-view="notifications">
                        <span style="font-size: 1.2rem;">🔔</span>
                    </div>
                `}
            </div>
